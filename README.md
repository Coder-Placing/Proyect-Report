...
|2.00|3/05/2026  | Martinez Gaona, Pablo Afranio | Construccion inicial de Capitulo III y IV
|2.01|14/05/2026  | Todos los integrantes | Finalizacion de Capitulo III y Capitulo IV
|3.01|14/06/2026  | Todos los integrantes | Sprint 2 y entrevistas de validacion
|4.01|10/07/2026  | Todos los integrantes | Finalizacion de Documento
...
La oportunidad de mercado es viable: el contexto de conectividad móvil en Perú y la intención de remodelación en hogares respaldan la adopción de una solución digital mobile-first.

La propuesta de valor está bien diferenciada frente a soluciones tradicionales, al integrar en una sola plataforma contratación, seguimiento operativo, control de pagos y monitoreo IoT.
...
Priorizar un MVP corto con 3 capacidades núcleo: seguimiento de avance, registro de incidencias y notificaciones; dejar funciones avanzadas para iteraciones posteriores.

Convertir las hipótesis en métricas operativas con metas trimestrales claras (activación, frecuencia de uso, tiempo de respuesta a alertas y retención por rol).

Ejecutar pruebas de usabilidad con ambos segmentos antes de desarrollar en grande, enfocándose en tareas críticas de menos de 3 pasos.
...
Redacción Perú21. (2023). El 17% de los peruanos desea realizar remodelaciones en sus viviendas, según estudio. Perú21. https://peru21.pe/peru/17-de-los-peruanos-desea-realizar-remodelaciones-en-sus-viviendas-casa-remodelacion-peru-viviendas-espacio-libre-noticia/

Cámara Peruana de la Construcción. (s. f.). CAPECO: El 2024 será un año retador para la industria de la construcción (y para el Perú) – Proyecciones sectoriales. https://capeco.org/el-2024-sera-un-ano-retador-para-la-construccion-y-para-el-peru/

Cámara Peruana de la Construcción. (2023). Informe Económico de la Construcción (N.° 64). https://iec.capeco.org/descargas/IEC64_0423.pdf

Designer landing page. (2024, 29 marzo). Houzz. https://pro.houzz.es/for-pros/interior-design-software

SmartThings Developer Center - Build Connected Experiences for Millions of Users - SmartThings Developers. (s. f.). https://developer.smartthings.com/

## Anexos

Enlace de presentacion: https://www.canva.com/design/DAHHzlj_6zg/G0jspEwKZyDt-XbYZQxLvQ/edit 

Enlace de Repositorio: https://github.com/Coder-Placing

Enlace de Repositorio Backend: https://github.com/Coder-Placing/Backend

Enlace de Repositorio Frontend: https://github.com/Coder-Placing/SpacePulse-AppMobile

Enlace de Repositorio Landing Page: https://github.com/Coder-Placing/LandingPage-SpacePulse
